...
public class BlackUnboundedReachValues extends UnboundedReachValues{
  ...
  private Int2ObjectFunction<Int2ObjectFunction<Int2ObjectFunction<Pair<Double, Double>>>> confidenceWidthFunction = x -> (y -> (z -> (new Pair<>(0.0, 1.0))));
  ...
  public void resetConfidenceWidthFunction(){
    this.confidenceWidthFunction = x -> (y -> (z -> (new Pair<>(0.0, 1.0))));
  }
