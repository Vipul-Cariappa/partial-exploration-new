...
public class DefaultInputValues {
    ...
    public static final TransitionProbabilityMethod TRANSITION_PROBABILITY_METHOD = TransitionProbabilityMethod.Martingale;
    ...
    public static final String targetLabel = null;
}
